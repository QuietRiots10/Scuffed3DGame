...
[CustomEditor(typeof(PistolEnemyBehaviorScript))]
public class PistolEnemyViewconeVisualizerScript : Editor
{
    private void OnSceneGUI()
    {
        PistolEnemyBehaviorScript Viewcone = (PistolEnemyBehaviorScript)target;
